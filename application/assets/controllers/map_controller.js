...
export default class extends Controller {
  ...
  static values = {
    ...
    region: {
      type: Object,
      default: { zoom: 15, longitude: 7.424450755119324, latitude: 43.738347784533 },
    },
  ...
  updateUrl() {
    history.pushState(
      ...
      '/' +
        this.styleUrlValue +
        '#' +
        this.regionValue.zoom +
        '/' +
        this.regionValue.longitude +
        '/' +
        this.regionValue.latitude
    );
  }
